...
namespace DevKbfSteel.Areas.MagasinAgent.Controllers
{
    ...
    public class SortiesController : Controller
    {
        ...
        public async Task<IActionResult> Post(string values)
        {
            ...
            model.CodeServiceEmetteur = XpertHelper.CodeServiceFicheArticleMagasin;
            model.NumDemandeFourniture = XpertHelper.NumDemandeFournitureMagasinAgent;
        ...
        public async Task<IActionResult> PostDetail(string values)
        {
            ...
            model.NumBonSortie = XpertHelper.NumBonSortieMagasinAgent;
