...
namespace DevKbfSteel.Controllers
{
    ...
    public class GestionPersonnelsMecaniqueController : Controller
    {
        private KBFsteelContext _context;
        public GestionPersonnelsMecaniqueController(KBFsteelContext context) {
            _context = context;
        }
        [HttpGet]
        public async Task<IActionResult> Get(DataSourceLoadOptions loadOptions) {
            var intervenants = _context.RhListeDesEmployes
                ...
                .Where(c =>c.Departement == XpertHelper.CodeMecanqiue)
                .Select(i => new {
                    i.Id,
                    i.Nom,
                    i.Prenom,
