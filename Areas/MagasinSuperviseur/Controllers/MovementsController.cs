        ...
        public object GetSuiviMovements(DateTime dateDebut, DateTime dateFin, DataSourceLoadOptions loadOptions)
        {
            ...
            foreach (var movement in StkMovements)
            {
                ...
                if (String.IsNullOrEmpty(suiviMovementsModel.ArticleNonGere))
                {
                    ...
                    if (suiviMovementsModel.TypeMovement == XpertHelperMagasinSuperviseur.typeMovment_Entree)
                    {
                    ...
                    if (suiviMovementsModel.TypeMovement == XpertHelperMagasinSuperviseur.typeMovment_Sortie)
                    {
                    ...
                    if (suiviMovementsModel.TypeMovement == XpertHelperMagasinSuperviseur.typeMovment_Affectation)
                    {
                    ...
                    if (suiviMovementsModel.TypeMovement == XpertHelperMagasinSuperviseur.typeMovment_Decharge)
                    {
                    ...
                    if (suiviMovementsModel.TypeMovement == XpertHelperMagasinSuperviseur.typeMovment_Reintegration)
                    {
                    ...
                    if (suiviMovementsModel.TypeMovement == XpertHelperMagasinSuperviseur.typeMovment_Restitution)
                    {
                    ...
                    if (suiviMovementsModel.TypeMovement == XpertHelperMagasinSuperviseur.typeMovment_Retour)
                    {
