...
namespace DevKbfSteel.Areas.GestionnaireMagasin.Controllers
{
    ...
    public class TransfertController : Controller
    {
        ...
        {
            XpertHelperGestionnaireMagasin.NumBonTransfert = NumBonTransfert;
        ...
        public async Task<IActionResult> PostTransfertArticles(string values)
        {
            ...
            var StkBonTransfert = _context.StkBonTransfert
                .Where(c => c.NumBonTransfert == (int)XpertHelperGestionnaireMagasin.NumBonTransfert)
                .Select(i => new {
                    i.DateTransfert
                }).Last();
            ...
            model.NumBonTransfert = (int)XpertHelperGestionnaireMagasin.NumBonTransfert;
        ...
        [HttpDelete]
        public async Task DeleteTransfert(int key)
        {
            var model = await _context.StkBonTransfert.FirstOrDefaultAsync(item => item.NumBonTransfert == key);
        ...
        {
            XpertHelperGestionnaireMagasin.NumBonRetourTransfert = NumBonRetourTransfert;
        ...
        public async Task<IActionResult> PostRetourTransfertArticles(string values)
        {
            ...
            model.NumBonRetourTransfert = (int)XpertHelperGestionnaireMagasin.NumBonRetourTransfert;
