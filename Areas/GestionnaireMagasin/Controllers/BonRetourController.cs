...
namespace DevKbfSteel.Areas.GestionnaireMagasin.Controllers
{
    ...
    public class BonRetourController : Controller
    {
        ...
        {
            XpertHelperGestionnaireMagasin.NumBonRetour = id;
        ...
        public async Task<IActionResult> PostBonRetourDetails(string values)
        {
            ...
            var SrkBonRetour = _context.SrkBonRetour
                .AsNoTracking()
                .Where(o => o.NumBonRetour == XpertHelperGestionnaireMagasin.NumBonRetour)
                .Select(i => new
                {
                    i.DateRetour
                }).ToList();
            ...
            else
            {
                if (SrkBonRetour.Count() > 0)
                {
                    ...
                    model.DateRetour = SrkBonRetour.Last().DateRetour.AddHours(14);
                    model.NumBonRetour = XpertHelperGestionnaireMagasin.NumBonRetour;
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            movement.TypeMovement = 8;// 3 pour les retours
                            movement.TypeValorisation = (int)pdrValorisation.Last().TypeValorisation;
                            movement.IdDetail = model.Id;
