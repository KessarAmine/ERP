...
namespace DevKbfSteel.Areas.GestionnaireMagasin.Controllers
{
    ...
    public class RestitutionController : Controller
    {
        ...
        {
            XpertHelperGestionnaireMagasin.NumDecharge = id;
        ...
        {
            XpertHelperGestionnaireMagasin.NumRestitution = id;
        ...
        public async Task<IActionResult> PostRestitution(string values)
        {
            ...
            model.NumDecharge = XpertHelperGestionnaireMagasin.NumDecharge;
        ...
        public async Task<IActionResult> PostRestitutionDetails(string values)
        {
            ...
            var StkRestitution = _context.StkRestitution
                .Where(c => c.NumDecharge == XpertHelperGestionnaireMagasin.NumDecharge)
                .Select(i => new {
                    i.DateRestitution
                }).ToList().Last();
            ...
            model.NumRestitution = XpertHelperGestionnaireMagasin.NumRestitution;
            //ADD TO MOVEMENTS
