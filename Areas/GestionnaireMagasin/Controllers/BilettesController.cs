...
namespace DevKbfSteel.Areas.GestionnaireMagasin.Controllers
{
    ...
    public class BilettesController : Controller
    {
        ...
        {
            XpertHelperGestionnaireMagasin.NumTransfertBilletteMagasin = id;
        ...
        {
            XpertHelperGestionnaireMagasin.NumReceptionBilletteMagasin = id;
        ...
        public async Task<IActionResult> PostReceptionBilletteDetails(string values)
        {
            ...
            model.NumReception = (int)XpertHelperGestionnaireMagasin.NumReceptionBilletteMagasin;
        ...
        public async Task<IActionResult> PostTransfertBilletteDetails(string values)
        {
            ...
            model.NumRapportTransfert = (int)XpertHelperGestionnaireMagasin.NumTransfertBilletteMagasin;
