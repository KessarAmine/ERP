...
namespace DevKbfSteel.Areas.GestionnaireMagasin.Controllers
{
    ...
    public class InventairesController : Controller
    {
        ...
        {
            XpertHelperGestionnaireMagasin.NumInventaire = id;
        ...
        {
            XpertHelperGestionnaireMagasin.NumInventaireEquipe = id;
        ...
        public async Task<IActionResult> PostInventaireLieu(string values)
        {
            ...
            model.NumInventaire = (int)XpertHelperGestionnaireMagasin.NumInventaire;
            ...
            foreach (var itemArticles in Articles)
            {
                var StkInventairesEquipes = _context.StkInventairesEquipes
                .AsNoTracking()
                .Where(o => o.NumInventaire == XpertHelperGestionnaireMagasin.NumInventaire)
                .Select(i => new
                {
                    i.Id
                }).ToList();
                foreach (var itemStkInventairesEquipes in StkInventairesEquipes)
                {
                    ...
                    modelArticle.NumInventaire = (int)XpertHelperGestionnaireMagasin.NumInventaire;
        ...
        public async Task<IActionResult> PostInventaireEquipeMembres(string values)
        {
            ...
            model.NumEquipe = (int)XpertHelperGestionnaireMagasin.NumInventaireEquipe;
        ...
        public async Task<IActionResult> EquipeLookup(DataSourceLoadOptions loadOptions)
        {
            var lookup = from i in _context.StkInventairesEquipes
                         where i.NumInventaire == XpertHelperGestionnaireMagasin.NumInventaire
                         select new
                         {
                             Value = i.Id,
                             Text = i.NomEquipe
